...
public class AddressController {
    ...
    @Autowired
    public AddressController(AddressService addressService, TariffService tariffService, ConversionService conversionService){
    ...
    @PostMapping
    public ResponseEntity addAddress(@RequestBody AddressDto address) throws AddressExistsException, TariffNotExistsException {
    ...
    public ResponseEntity<List<AddressDto>> getAll(Pageable pageable){
        ...
        Page pageDto = page.map(address -> conversionService.convert(address, AddressDto.class));
